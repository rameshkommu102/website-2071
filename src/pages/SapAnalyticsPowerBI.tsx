  ...
  const panels = [
    {
      ...
      desc: "Gain real-time visibility into cash flow efficiency, liquidity performance, and operational cash movement across the business.",
      chips: ["Cash Optimization", "DSO / DIO Tracking", "Real-Time Monitoring"],
    },
    {
      ...
      desc: "Gain complete visibility into purchase trends, supplier performance, material costs, and purchase order variance across the procurement network.",
      chips: ["Cost Analysis", "Supplier Trends", "PO Variance"],
    },
    {
      ...
      desc: "Track sales performance, revenue trends, returns, and profit margins across stores, products, and promotional campaigns in real time.",
      chips: ["Key Metrics", "Trend Analysis", "Market Analysis"],
    },
    {
      label: "Accounts Receivable Aging Analytics",
      role: "CFO",
      kicker: "Receivables",
      title: "Accounts Receivable Aging Analytics",
      desc: "Monitor outstanding receivables, overdue balances, customer credit risk, and collection trends to improve cash flow visibility and recovery performance.",
      chips: ["Aging Summary", "Overdue Tracking", "Payment Recovery"],
    },
    {
      label: "Accounts Payables Analytics",
      role: "CFO",
      kicker: "Payables",
      title: "Accounts Payables Analytics",
      desc: "Track accounts payables milestones, vendor exposure, and payment efficiency to optimize working capital and cash flow management.",
      chips: ["Due Forecast", "Vendor Aging", "Payment Efficiency"],
    },
  ];
