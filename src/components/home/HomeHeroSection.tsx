            ...
            <div className="grid grid-cols-2 sm:flex sm:flex-nowrap items-center justify-items-start sm:justify-between gap-x-3 gap-y-3 sm:gap-0">
              {capabilities.map(({ icon: Icon, label }) => (
                <a
                  key={label}
                  href="#"
                  className="flex items-center gap-2 sm:gap-1.5 xl:gap-2.5 whitespace-nowrap text-[12px] sm:text-[11px] md:text-[12px] lg:text-[11px] xl:text-[14px] 2xl:text-[15px] text-foreground/80 transition-colors hover:text-foreground"
                >
